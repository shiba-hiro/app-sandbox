...
var LanguageWhere = struct {
	...
	ID:       whereHelperint{field: "\"app_default\".\"languages\".\"id\""},
	Language: whereHelperstring{field: "\"app_default\".\"languages\".\"language\""},
}
...
func (r *languageR) GetPilots() PilotSlice {
	if r == nil {
		return nil
	}
	return r.Pilots
...
func (o *Language) Pilots(mods ...qm.QueryMod) pilotQuery {
	...
	queryMods = append(queryMods,
		qm.InnerJoin("\"app_default\".\"pilot_languages\" on \"app_default\".\"pilots\".\"id\" = \"app_default\".\"pilot_languages\".\"pilot_id\""),
		qm.Where("\"app_default\".\"pilot_languages\".\"language_id\"=?", o.ID),
	)
...
func (languageL) LoadPilots(ctx context.Context, e boil.ContextExecutor, singular bool, maybeLanguage interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.Select("\"app_default\".\"pilots\".\"id\", \"app_default\".\"pilots\".\"name\", \"a\".\"language_id\""),
		qm.From("\"app_default\".\"pilots\""),
		qm.InnerJoin("\"app_default\".\"pilot_languages\" as \"a\" on \"app_default\".\"pilots\".\"id\" = \"a\".\"pilot_id\""),
...
func (o *Language) AddPilots(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Pilot) error {
	...
	for _, rel := range related {
		query := "insert into \"app_default\".\"pilot_languages\" (\"language_id\", \"pilot_id\") values ($1, $2)"
...
func (o *Language) SetPilots(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Pilot) error {
	query := "delete from \"app_default\".\"pilot_languages\" where \"language_id\" = $1"
...
func (o *Language) RemovePilots(ctx context.Context, exec boil.ContextExecutor, related ...*Pilot) error {
	...
	var err error
	query := fmt.Sprintf(
		"delete from \"app_default\".\"pilot_languages\" where \"language_id\" = $1 and \"pilot_id\" in (%s)",
...
func Languages(mods ...qm.QueryMod) languageQuery {
	mods = append(mods, qm.From("\"app_default\".\"languages\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"app_default\".\"languages\".*"})
	}
...
func FindLanguage(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*Language, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"app_default\".\"languages\" where \"id\"=$1", sel,
	)
...
func (o *Language) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"app_default\".\"languages\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"app_default\".\"languages\" %sDEFAULT VALUES%s"
		}
...
func (o *Language) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		cache.query = fmt.Sprintf("UPDATE \"app_default\".\"languages\" SET %s WHERE %s",
...
func (o LanguageSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"app_default\".\"languages\" SET %s WHERE %s",
...
func (o *Language) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"app_default\".\"languages\"", updateOnConflict, ret, update, conflict, insert)
...
func (o *Language) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"app_default\".\"languages\" WHERE \"id\"=$1"
...
func (o LanguageSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"app_default\".\"languages\" WHERE " +
...
func (o *LanguageSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"app_default\".\"languages\".* FROM \"app_default\".\"languages\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, languagePrimaryKeyColumns, len(*o))
...
func LanguageExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"app_default\".\"languages\" where \"id\"=$1 limit 1)"
