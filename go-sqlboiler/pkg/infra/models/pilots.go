...
var PilotWhere = struct {
	...
	ID:   whereHelperint{field: "\"app_default\".\"pilots\".\"id\""},
	Name: whereHelperstring{field: "\"app_default\".\"pilots\".\"name\""},
}
...
func (o *Pilot) Jets(mods ...qm.QueryMod) jetQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"app_default\".\"jets\".\"pilot_id\"=?", o.ID),
	)
...
func (o *Pilot) Languages(mods ...qm.QueryMod) languageQuery {
	...
	queryMods = append(queryMods,
		qm.InnerJoin("\"app_default\".\"pilot_languages\" on \"app_default\".\"languages\".\"id\" = \"app_default\".\"pilot_languages\".\"language_id\""),
		qm.Where("\"app_default\".\"pilot_languages\".\"pilot_id\"=?", o.ID),
	)
...
func (pilotL) LoadJets(ctx context.Context, e boil.ContextExecutor, singular bool, maybePilot interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`app_default.jets`),
		qm.WhereIn(`app_default.jets.pilot_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (pilotL) LoadLanguages(ctx context.Context, e boil.ContextExecutor, singular bool, maybePilot interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.Select("\"app_default\".\"languages\".\"id\", \"app_default\".\"languages\".\"language\", \"a\".\"pilot_id\""),
		qm.From("\"app_default\".\"languages\""),
		qm.InnerJoin("\"app_default\".\"pilot_languages\" as \"a\" on \"app_default\".\"languages\".\"id\" = \"a\".\"language_id\""),
	...
	for _, rel := range related {
		if insert {
			...
			updateQuery := fmt.Sprintf(
				"UPDATE \"app_default\".\"jets\" SET %s WHERE %s",
...
func (o *Pilot) AddLanguages(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Language) error {
	...
	for _, rel := range related {
		query := "insert into \"app_default\".\"pilot_languages\" (\"pilot_id\", \"language_id\") values ($1, $2)"
		values := []interface{}{o.ID, rel.ID}
...
func (o *Pilot) SetLanguages(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Language) error {
	query := "delete from \"app_default\".\"pilot_languages\" where \"pilot_id\" = $1"
...
func (o *Pilot) RemoveLanguages(ctx context.Context, exec boil.ContextExecutor, related ...*Language) error {
	...
	var err error
	query := fmt.Sprintf(
		"delete from \"app_default\".\"pilot_languages\" where \"pilot_id\" = $1 and \"language_id\" in (%s)",
...
func Pilots(mods ...qm.QueryMod) pilotQuery {
	mods = append(mods, qm.From("\"app_default\".\"pilots\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"app_default\".\"pilots\".*"})
	}
...
func FindPilot(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*Pilot, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"app_default\".\"pilots\" where \"id\"=$1", sel,
	)
...
func (o *Pilot) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"app_default\".\"pilots\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"app_default\".\"pilots\" %sDEFAULT VALUES%s"
		}
...
func (o *Pilot) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		cache.query = fmt.Sprintf("UPDATE \"app_default\".\"pilots\" SET %s WHERE %s",
...
func (o PilotSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"app_default\".\"pilots\" SET %s WHERE %s",
...
func (o *Pilot) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"app_default\".\"pilots\"", updateOnConflict, ret, update, conflict, insert)
...
func (o *Pilot) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"app_default\".\"pilots\" WHERE \"id\"=$1"
...
func (o PilotSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"app_default\".\"pilots\" WHERE " +
...
func (o *PilotSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"app_default\".\"pilots\".* FROM \"app_default\".\"pilots\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, pilotPrimaryKeyColumns, len(*o))
...
func PilotExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"app_default\".\"pilots\" where \"id\"=$1 limit 1)"
...
// Exists checks if the Pilot row exists.
func (o *Pilot) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return PilotExists(ctx, exec, o.ID)
}
